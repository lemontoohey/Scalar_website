  ...
  useEffect(() => {
    ...
    const handleMouseEnter = (e: MouseEvent) => {
      ...
      if (target.tagName === 'A' || target.tagName === 'BUTTON' || target.closest('a, button')) {
        ...
        const scalarRed = 168 // #A80000 red component
        ...
        const animate = () => {
          ...
          if (progress < 0.7) {
            ...
            currentKelvin = startKelvin + (endKelvin - startKelvin) * (progress / 0.7)
            setKelvin(currentKelvin)
            requestAnimationFrame(animate)
          } else {
            // Land on Scalar Red
            setKelvin(2000) // Close to red
          }
        }
